...
# Ensure CRS consistency (CRITICAL)
...
with col_map:
    ...
    # Polygon-based statistics (TABLE ONLY)
...
with col_chart:
    ...
    if idse_selected == "No filter":
        ...
        # =====================================================
        # Sex pie chart for selected SE (UNCHANGED)
        # =====================================================
...
st.markdown("""
---
**Geospatial Enterprise Web Mapping** – Streamlit, Folium & GeoPandas  
